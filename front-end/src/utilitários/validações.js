...
export function validarConfirmacaoSenhaOpcional(senha, confirmacao_senha) {
  ...
  if (senha && confirmacao_senha && senha !== confirmacao_senha) {
    errosConfirmaçãoSenhaOpcional.confirmacaoSenha = ERRO_CONFIRMAÇÃO_SENHA;
  }
...
export function validarConfirmacaoSenha(senha, confirmação_senha) { let errosConfirmaçãoSenhaOpcional = {}; if (senha !== confirmação_senha) { errosConfirmaçãoSenhaOpcional.confirmação_senha = ERRO_CONFIRMAÇÃO_SENHA; }
return errosConfirmaçãoSenhaOpcional; }
export function validarRecuperacaoAcessoOpcional(questão, resposta) {
